...
/**
 * Funkcija proverava koji je sledeci karakter, ali ne pomera bafer
 * @return sledeci karakter
 */
int8_t usartPeek();

/**
 * Funkcija ocitava sve karaktere iz prijemnog bafera i od njih formira int16_t.
 * @return ucitan int16_t
 */
